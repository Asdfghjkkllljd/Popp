api_id = 24737448 # Ваш апи айди без кавычек
api_hash='73642f0e524e23848f245188cd8e1e62' # Ваш апи ключ указывать в кавычках
...
avto_vivod_tag = 'CEKCOX' # Тег аккаунта(без @), куда раз в сутки будет отправляться чек со всеми собранными средствами. Например avto_vivod_tag = 'absolutely_enough'
